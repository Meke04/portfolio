...
export default function enki() {
    ...
    return(
        <main className="flex w-full bg-black text-white p-10">
            <div className="flex flex-col w-1/2">

                <div className="border p-2 rounded-2xl w-fit bg-white hover:-translate-y-1">
                    <Link href="/" className="text-2xl text-gray-900">Ir para o inicio</Link>
                </div>

                <div className="flex px-10 py-10">
                    <Image src="/site1image1.png" alt="image1" width={1917} height={947} className="w-206 h-103"/>
                </div>

                <div className="flex px-10 py-10">
                    <Image src="/site1image2.png" alt="image1" width={1917} height={947} className="w-206 h-103"/>
                </div>

                <div className="flex px-10 py-10">
                    <Image src="/site1image3.png" alt="image1" width={1917} height={947} className="w-206 h-103"/>
                </div>

                <div className="flex px-10 py-10">
                    <Image src="/site1image4.png" alt="image1" width={1917} height={947} className="w-206 h-103"/>
                </div>

            </div>

            <div className="flex flex-col w-1/2 p-10 gap-4 text-2xl bg-gray-900 shadow-[0_0_5px_rgb(255,255,255,0.9)]  text-white">
